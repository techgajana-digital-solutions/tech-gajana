...
import { getEventBySlug, standardChecklist } from '@/lib/events-data'
...
export default function EventDetailsPage({ params }: { params: Promise<{ slug: string }> }) {
  // `params` is a Promise in Next.js 15+ — client components must unwrap it
  // with React's `use()` hook rather than reading it directly or awaiting it.
